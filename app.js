...
let min = 1,
    ...
    winningNum = Math.floor(Math.random() * Math.floor(max)) + min,
    guessesLeft = 3;
        ...
        if (isNaN(guess) || guess < min || guess > max) {
            ...
            if (guess === winningNum) {
                ...
                if (guessesLeft === 0) {
                    ...
                    if (guess < winningNum) {
                        setMessage(`${guess} is smaller than Winning Number, ${guessesLeft} ${guessOrguesses} Left `, 'red');
                    } else if (guess > winningNum) {
                        setMessage(`${guess} is bigger than Winning Number, ${guessesLeft} ${guessOrguesses} Left `, 'red');
                    }
